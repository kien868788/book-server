package com.bookstore.app.auth;

import com.bookstore.app.user.User;
import com.bookstore.security.CustomUserService;
...
public class AuthController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody com.bookstore.app.auth.AccountCredentials accountCredentials) {
